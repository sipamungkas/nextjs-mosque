...
const Infaq = (props: InfaqProps) => {
  const { detail } = props;
  return (
    <section id="infaq" className="relative bg-black py-20 md:py-24">
      <Image
      ...
      <div className="relative flex flex-col w-full px-4 xl:px-0 items-center justify-center">
        <div className="container mx-auto items-center justify-center tracking-wider">
          ...
          <Link href={`https://wa.me/${detail.waNumber}?text=${detail.waText}`}>
            <button className="mx-auto bg-[#25D366] text-white font-medium py-3 px-5 md:py-2 md:px-4 rounded flex items-center justify-center">
              Berinfaq Sekarang <AiOutlineWhatsApp className="ml-2" size={20} />
            </button>
          </Link>
          <h3 className="text-white text-sm sm:text-base md:text-lg font-normal leading-loose mt-12 md:mt-20 md:mb-12 lg:my-12 text-center">
            ...
            jama’ah sekalian, baiklah Allah Subhanahu Wa Ta’ala memberi ganjaran
            atas semua kebaikan dan keikhlasan jamaa’ah sekalian, Barakallahu
            fiikum
            <br />
            <br />
            Catatan : <br />
